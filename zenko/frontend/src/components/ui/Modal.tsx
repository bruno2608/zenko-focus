  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-slate-900/30 px-4 py-6 backdrop-blur-sm transition-colors dark:bg-slate-950/80 sm:items-center">
      <div
        ...
        tabIndex={-1}
        className="w-full max-w-xl rounded-3xl border border-slate-200 bg-white p-6 shadow-[0_25px_60px_-15px_rgba(15,23,42,0.18)] backdrop-blur dark:border-white/10 dark:bg-slate-900/80 dark:shadow-[0_25px_60px_-15px_rgba(15,23,42,0.8)]"
      >
