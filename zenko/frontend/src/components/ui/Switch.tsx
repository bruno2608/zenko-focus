...
export default function Switch({ checked, onCheckedChange }: SwitchProps) {
  ...
  const checkedStyles =
    'bg-gradient-to-r from-zenko-primary to-zenko-secondary border-white/40 shadow-[0_8px_20px_rgba(39,102,255,0.45)]';
    ...
    >
      ...
      <span
        className={`inline-block h-5 w-5 transform rounded-full transition-all duration-300 ${
          checked
            ? 'translate-x-6 bg-white shadow-[0_5px_15px_rgba(39,102,255,0.45)]'
